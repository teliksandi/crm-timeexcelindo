<?php /* Smarty version Smarty-3.0.7, created on 2017-08-14 04:36:30
         compiled from "application/views\master/Initiation/index.html" */ ?>
<?php /*%%SmartyHeaderCode:1315759910cae33af55-35382555%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f2e98a72238cbb2574a19bf8630bf46f4e125ed4' => 
    array (
  ...
  'nocache_hash' => '1315759910cae33af55-35382555',
  'function' => 
  array (
  ),
...
" method="post">
                        <div class="box-body">
                            <div class="form-group">
                                <label for="project_name" class="col-sm-2 control-label">Nama Project</label>
                                <div class="col-sm-4">
                                    <input type="text" name="project_name" value="<?php echo (($tmp = @$_smarty_tpl->getVariable('search')->value['project_name'])===null||$tmp==='' ? '' : $tmp);?>
" class="form-control" id="project_name" placeholder="">
                                </div>
                                <div class="col-sm-4">
