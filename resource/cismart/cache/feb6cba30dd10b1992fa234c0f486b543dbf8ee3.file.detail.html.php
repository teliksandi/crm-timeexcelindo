<?php /* Smarty version Smarty-3.0.7, created on 2017-11-16 07:54:40
         compiled from "application/views\execution/detail.html" */ ?>
<?php /*%%SmartyHeaderCode:17129503435a0d363068bf58-25582992%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'feb6cba30dd10b1992fa234c0f486b543dbf8ee3' => 
    array (
      0 => 'application/views\\execution/detail.html',
      1 => 1510814805,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '17129503435a0d363068bf58-25582992',
  'function' => 
  array (
  ),
...
" 
                                            ...
                                            <label>Team Member Name</label>
                                            <br>
                                                <select name="karyawan[]" title="Pilih Anggota Tim" class="form-control select2 " data-value="" multiple="multiple" readonly disabled style="width: 100%;">
                                                    <?php  $_smarty_tpl->tpl_vars['value'] = new Smarty_Variable;
...
" class="form-control" id="budget" placeholder="" title="Estimasi harga" readonly >
                                        ...
                                        <table>
                                            <tr>
                                                <td width="200px"><b><h5>Start Date</h5></b></td>
                                                <td>            </td>
                                                <td width="200px"><b><h5>Due Date</h5></b></td>
                                            </tr>
                                            <tr>
                                                <td>
...
<?php $_tmp1=ob_get_clean();?><?php if ($_tmp1==1){?>
                            ...
                            <div class="col-md-6">
                            <form class="form-horizontal" action="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('execution/execution/komentar_process');?>
" method="post">
                                    <div class="form-group">
                                            <table>
                                                <div style="overflow-y: scroll; height: 200px">
