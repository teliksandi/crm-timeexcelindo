<?php /* Smarty version Smarty-3.0.7, created on 2017-09-19 05:47:46
         compiled from "application/views\initiation/detail.html" */ ?>
<?php /*%%SmartyHeaderCode:2175259c0936272cd31-50002229%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '2175259c0936272cd31-50002229',
  'function' => 
  array (
  ),
...
">
                ...
                <form class="form-horizontal" action="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('closing/closing/closing_process');?>
" method="post">
                    <input type="hidden" name="init_closing" value="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['jn']->value['id_initiation'])===null||$tmp==='' ? '' : $tmp);?>
">
