...
class rejecting extends ApplicationBase {
    ...
    public function __construct() {
        ...
        $this->load->model("closing/m_rejecting");
    ...
    public function index() {
        ...
        $this->smarty->assign("template_content", "closing/rejecting/index.html");
        ...
        $config['base_url'] = site_url("closing/rejecting/index/");
        $config['total_rows'] = $this->m_rejecting->search_closing($filter, $ttl_rows);
        ...
        $this->smarty->assign("closing", $this->m_rejecting->get_list_closing($filter, $params));
        // get list data
        // get list data
    ...
    function closing_process(){
        ...
        $this->_set_page_rule("C");
            ...
            $this->m_rejecting->insert_closing($params);
