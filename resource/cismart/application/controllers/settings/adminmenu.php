...
class adminmenu extends ApplicationBase {
    ...
    public function add($portal_id) {
        ...
        $this->smarty->load_javascript("resource/js/iconpicker/fontawesome-iconpicker.js");
        $this->smarty->load_style("adminlte/plugins/bootstrap/css/bootstrap.min.css");
        $this->smarty->load_style("adminlte/plugins/font-awesome/css/font-awesome.min.css");
        $this->smarty->load_style("iconpicker/fontawesome-iconpicker.css");
        // set template content
    ...
    public function process_add() {
        ...
        if ($this->tnotification->run() !== FALSE) {
            ...
            $params = array($this->input->post('portal_id'), $this->input->post('parent_id'), $this->input->post('nav_title'),
                ...
                $this->input->post('active_st'), $this->input->post('display_st'), $this->input->post('nav_icon'), $this->com_user['user_id']);
            // insert
