...
class m_settings extends CI_Model {
    ...
    function insert_menu($params) {
        $sql = "INSERT INTO com_menu (portal_id, parent_id, nav_title, nav_desc, nav_url, nav_no, active_st, display_st, nav_icon, mdb, mdd)
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, NOW())";
        return $this->db->query($sql, $params);
    }
    ...
    function update_menu($params) {
        $sql = "UPDATE com_menu
                SET portal_id = ?, parent_id = ?, nav_title = ?, nav_desc = ?, nav_url = ?, nav_no = ?, active_st = ?, display_st = ?, nav_icon = ?, mdb = ?
                WHERE nav_id = ?";
        return $this->db->query($sql, $params);
    }
    ...
    function insert_user_detail($params) {
        $sql = "INSERT INTO users (user_id, nama_lengkap, alamat, no_telp, mdb,mdd) VALUES (?, ?, ?, ?, ?, NOW())";
        return $this->db->query($sql, $params);
    }
